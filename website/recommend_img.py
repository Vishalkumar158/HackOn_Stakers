...
def recommend(detected_object_class, photo_name):
    ...
    json_input_path = os.path.join('.','website/static/detected_obj.json')
    ...
    image_database_dir = os.path.join('.', 'website/static/product_images/cropped_rec')  # Adjust this path as needed
    ...
    def extract_class_specific_features(product_data, detected_object_class):
        ...
        for img_name in matching_products['image_name']:
            try:
                ...
                if img_name:
                    img_path = os.path.join('.','website/static/product_images/cropped_rec',detected_object_class,img_name)
